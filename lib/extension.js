...
function activate (context) {
  ...
  const dispAutocomplete = vscode.languages.registerCompletionItemProvider(['javascript', 'javascriptreact', 'typescript'], new ExportersCompletionItemProvider())
